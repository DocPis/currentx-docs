...
- [Uniswap V3 (CurrentX V3)](#uniswap-v3-currentx-v3)
- [Tokens](#tokens)
- [Other](#other)
- [Notes](#notes)
...
- RPC (primary): `https://mainnet.megaeth.com/rpc`
- RPC (fallbacks, if reachable):
...
| Component | Address |
| --- | --- |
| Factory | `0xC60940F182F7699522970517f6d753A560546937` |
| Router | `0x189b27c207b4cBBae1C65086F31383532443f5f2` |
| Pair init code hash | `0x552cb211a6cb6b2c7b263255f787f454e28411eb3ffb49389d5b6e73cd2966d0` |

## Uniswap V3 (CurrentX V3)

| Component | Address |
| --- | --- |
| Factory | `0x09cF8A0b9e8C89bff6d1ACbe1467e8E335Bdd03E` |
| Quoter V2 | `0x962e62df3df243844bd89ffb5b061919725dca2d` |
...
| Timestamp Oracle | `0x6342000000000000000000000000000000000002` |

## Notes

- If any address is marked `TBD`, it is not set in the current on-chain config and should not be used until finalized.
