...
const config: Config = {
  ...
  organizationName: 'currentx', // Usually your org/user name.
  projectName: 'currentx-docs', // Usually your repo name.
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright (c) ${new Date().getFullYear()} CurrentX.`,
    },
    prism: {
